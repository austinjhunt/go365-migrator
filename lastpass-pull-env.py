...
username = input('Please enter your LastPass username (user@cofc.edu): ').strip()
...
try:
    ...
    lastpass_folder = input('Please enter the path to the parent folder of the .env secure note in LastPass (use a single backslash \\ to separate directories if nested): ')
    ...
    if found:
        ...
        print(f'LastPass environment file {lastpass_folder}\\.env was not found')
