...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('list_type', models.CharField(choices=[('GARU', 'Google OAuth Redirect URI'), ('GAJO', 'Google OAuth JS Origin')], default='GARU', max_length=5)),
                ('administration_settings', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.administrationsettings')),
            ],
        ),
    ]
